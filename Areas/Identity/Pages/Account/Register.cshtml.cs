...
namespace QanShop.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        private readonly SignInManager<QanShopUser> _signInManager;
        private readonly UserManager<QanShopUser> _userManager;
        private readonly IUserStore<QanShopUser> _userStore;
        private readonly IUserEmailStore<QanShopUser> _emailStore;
        private readonly ILogger<RegisterModel> _logger;
        private readonly IEmailSender _emailSender;

        public RegisterModel(
            UserManager<QanShopUser> userManager,
            IUserStore<QanShopUser> userStore,
            SignInManager<QanShopUser> signInManager,
        ...
        private IUserEmailStore<QanShopUser> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<QanShopUser>)_userStore;
        }
    }
}
